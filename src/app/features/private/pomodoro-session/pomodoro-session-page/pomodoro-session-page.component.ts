...
@Component({
  ...
  templateUrl: './pomodoro-session-page.component.html',
  standalone: true,
  styleUrl: './pomodoro-session-page.component.css',
})
export class PomodoroSessionPageComponent implements OnInit, OnDestroy {
