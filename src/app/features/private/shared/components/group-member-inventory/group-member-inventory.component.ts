...
export class GroupMemberInventoryComponent implements OnInit
{
  ...
  private readonly groupMemberInventoryApi = inject(GroupMemberInventoryApiService)
  ...
  load(page:number)
  {
    ...
    this.groupMemberInventoryApi.getMemberInventory(this.group().groupId,this.memberId(),this.isUsedUp(),page,10)
